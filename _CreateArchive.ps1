<#
.SYNOPSIS
  Packaging of Joomla plugin files
.DESCRIPTION
  This script packs all needed files of Joomla plugin together in a ZIP archive, so that it can be installed in Joomla.
.PARAMETER
  None
.INPUTS
...
$sDownloadURLPath = "https://raw.githubusercontent.com/heinchrs/kandandauserupdate/main/.release/"
